...
const Header = () => {
  ...
  return (
    <header className="flex h-16  mb-1 border-b bg-background/95 px-4 backdrop-blur shrink-0 items-center justify-between gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
        ...
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem className="">
              <BreadcrumbLink href="/">360Bnb</BreadcrumbLink>
            </BreadcrumbItem>
