...
function App() {
  ...
  const renderStep = () => {
    ...
    switch (currentStep) {
      ...
      case 4:
        return <div>{/*<AmenitiesStep {...stepProps} />; */}</div>
      case 5:
        return <div>{/*<PhotosStep {...stepProps} />*/};</div>
      case 6:
  ...
  return (
    <div className="min-h-screen relative bg-gray-50 w-full">
      ...
      {currentStep > 1 && (
        <div
          className="w-full h-full absolute top-0 z-10 bg-cover opacity-50"
      ...
      <main
        className={`${
          currentStep > 1
            ? "relative z-20 flex flex-col lg:flex-row items-center p-4 gap-12"
            : ""
        } `}
      >
